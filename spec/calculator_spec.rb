...
RSpec.describe Calculator do
  ...
  let (:calculation3){Calculator.new(4,12)}
  ...
  it '#divide returns "undefined" for num1/num2 when num2 is 0' do
    expect(calculation2.divide).to eql("undefined")
  end
  it '#mystery returns the result of a secret equation' do
    expect(calculation1.mystery(calculation3)).to eql(146)
  end
